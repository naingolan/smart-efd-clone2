...
@Component({
  selector: 'app-business-number-edit',
  templateUrl: './business-number-edit.component.html',
  styleUrls: ['./business-number-edit.component.css']
})
export class BusinessNumberEditComponent {

  customer: any;

  constructor(
    public dialogRef: MatDialogRef<BusinessNumberEditComponent>,
